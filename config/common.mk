...
PRODUCT_COPY_FILES += \
    ...
    vendor/cm/prebuilt/common/etc/init.d/95color:system/etc/init.d/95color \
...
ifeq ($(CM_BUILDTYPE), RELEASE)
    ifndef TARGET_VENDOR_RELEASE_BUILD_ID
        CM_VERSION := W03-CM$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(CM_BUILD)-$(shell date +"%Y%m%d-%H%M")
    else
    ...
    ifeq ($(PRODUCT_VERSION_MINOR),0)
        CM_VERSION := W03-CM$(PRODUCT_VERSION_MAJOR)-$(CM_BUILD)-$(shell date +"%Y%m%d-%H%M")
    else
        CM_VERSION := W03-CM$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(CM_BUILD)-$(shell date +"%Y%m%d-%H%M")
    endif
endif
